...
INSERT INTO pictures SELECT id, relative_path, width, height, name,
       extension, add_date, last_view, is_private, from_file, file_hash FROM pictures_old;
...
DROP INDEX position_sig;

DROP TABLE picture_signature_words;
